			...
			<main>
				<div class="fluid-container">
					...
					<div class="col-xs-10 col-md-10 col-xs-offset-1 col-md-offset-1" id="about">
						...
						<p class="bodyText"> Greg is an amateur photographer with a passion for capturing images of beautiful
							insects,
					...
					<div class="col-xs-10 col-md-10 col-xs-offset-1 col-md-offset-1">
						<div class="main-carousel popup-gallery"
							  data-flickity='{ "cellAlign": "right", "contain": true, "dragThreshold": 10, "adaptiveHeight": true, "imagesLoaded": true}'>
					...
					<div class="col-xs-10 col-md-5 col-xs-offset-1 col-md-offset-1" id="contact">
						...
						<p class="bodyText">If you’re interested in any of the wonders of the great outdoors captured by Greg
							Bloom, please feel free to contact him through this contact
							form.</p>
					</div>
